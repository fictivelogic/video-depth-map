        ...
        if foregroundHQuarterL[i] == 1
        {
            ...
            for (int j = i; j < i + sQuart; j++)
            {
                ...
                else
                {
                    ...
                    {
                        matchingCost[j-i] = //compute matching cost from openCV
                    }
                    else
                    {
                        matchingCost[j-i] = inf; //Syntax?
                    }
                }
            }
        ...
        if (foregroundHalfL[i] == 1)
        {
            ...
            for (int j = 2 * prevdisp - 2; j < 2 * prevdisp + 2; j++)
            {
                ...
                else
                {
                    ...
                    {
                        matchingCost[j - (2 * prevdisp - 2)] = //compute matching cost
                    }
                    else
                    {
                        matchingCost[j - (2 * prevdisp - 2)] = inf;
                    }
                }
